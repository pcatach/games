...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "27 gamma correction", nullptr, nullptr); // Windowed
    ...
    //glEnable(GL_FRAMEBUFFER_SRGB); // we can do this here or in the fragment shader
...
GLuint loadTexture(GLchar* path)
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_SRGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, image); //sRGB to automatically correct colors to linear space, ONLY USE FOR DIFFUSE TEXTURES!
