...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "17 Blending", nullptr, nullptr); // Windowed
    ...
    //glBlendFuncSeparate(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA, GL_ONE, GL_ZERO); // set RGB and A separatelly
    ...
    GLuint plantTexture = loadTexture("./grass.png");
    GLuint windowTexture = loadTexture("./blending_transparent_window.png");
