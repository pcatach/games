...
int main(){
  ...
  GLFWwindow* window = glfwCreateWindow(800, 600, "11 light maps", nullptr, nullptr);
  ...
  Shader lightingShader("./shader.vs", "./ex1.frag");
  ...
  unsigned char* image3 = SOIL_load_image("./matrix.jpg", &width, &height, 0, SOIL_LOAD_RGB);
