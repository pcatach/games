...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "20 cubemaps", nullptr, nullptr); // Windowed
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        //glDepthMask(GL_FALSE);// always in the background
        skyboxShader.Use();
